          ...
          <div className="shop-product-wrap grid with-pagination space-db--30 shop-border  row d-flex ">
              {
                  data && data.length > 0 && data.map((item,index)=>{
                      return (
                        <>
                          <div key={} className="col-lg-4 col-sm-6">
                                ...
                                <div className="product-card--body">
                                  ...
                                  <article>
                                    ...
                                    <p>
                                      ...
                                      storage and up to 40 hours of battery
                                      life, the new iPod classic lets you enjoy
                                  ...
                                  <div className="btn-block">
                                    ...
                                    <a href className="card-link">
                                      <i className="fas fa-heart" /> Add To
                                      Wishlist
                                    </a>
                                    <a href className="card-link">
                                      <i className="fas fa-random" /> Add To
                                      Cart
                                    </a>
                                  </div>
                                </div>
